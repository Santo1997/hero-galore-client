...
const DeleveryInfo = () => {
  return (
    <div>
      <h1 className="text-green-500 font-bold text-3xl lg:text-4xl text-center mt-10">
        Delivery Info
      </h1>
      <div className="grid lg:grid-cols-4 my-10">
        <div className="flex gap-3 p-3 my-5 lg:w-fit shadow-[0_0_8px_#0003] ">
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className="w-16 h-16 p-3 border rounded-md"
          >
            <path
              strokeLinecap="round"
